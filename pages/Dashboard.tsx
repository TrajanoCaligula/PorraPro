...
const Dashboard = () => {
  ...
  Aquí tienes el código completo y corregido del componente. He aplicado la envoltura de Link en toda la fila de la competición, corregido las importaciones y asegurado que me y upcomingMatches estén definidos para evitar errores de renderizado.
